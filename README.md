# Chrome Stalker
[![Build Windows Agents](https://github.com/WuzenLiz/chrome_stalker/actions/workflows/build.yml/badge.svg?branch=main&event=release)](https://github.com/WuzenLiz/chrome_stalker/actions/workflows/build.yml)
